...
import { Highlight } from "./carousal";
...
function ImagePopup({pic}) {
        return(
            <div className='imagePopup'>
                ...
                src={`https://image.tmdb.org/t/p/w500/${pic[0]?.backdrop_path}`}
                />

            </div>
        )
}
function ImageText({pic}) {
    return (
        <div className='desc'>
            ...
            <div className='secondBox'>
                ...
                <Text id='popularity'>
                    {pic[0]?.vote_average} &nbsp;&nbsp; 2h 30m 2020
                </Text>
            </div>
...
export default function Description() {
  ...
  var filteredData = trending?.filter((item)=>item?.id === +id)
...
//   }, []);
  return (
    ...
    <DashboardLayout>
      <ImagePopup pic={filteredData}/>
      <ImageText pic={filteredData}/>
      <ImageDesc pic={filteredData} />
